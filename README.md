...
> **Wichtig:** CheckMK **exportiert nicht** nach Prometheus. Die native Prometheus-Integration ist einseitig — CheckMK *scrapt* Prometheus (CheckMK als Konsument). Nativer Metrik-Export geht nur nach InfluxDB/Graphite. Bestätigt: `monitoring.example.com` läuft als **CheckMK 2.3.0 CEE** (Commercial Enterprise Edition).
