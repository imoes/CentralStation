...
GET https://monitoring.example.com/cmk/api/1.0/domain-types/metric/collections/all
```
...
scrape_configs:
  ...
  - job_name: 'node'
    static_configs:
      - targets:
          - 'docker001.example.com:9100'
          - 'docker086.example.com:9100'
  ...
  - job_name: 'checkmk'
    ...
    static_configs:
      - targets: ['monitoring.example.com:443']
    scheme: https
    tls_config:
...
scrape_configs:
  - job_name: 'checkmk_agent'
    static_configs:
      - targets: ['monitoring.example.com:8080']
