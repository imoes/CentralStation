...
SYSTEM_PROMPT = (
    ...
    "Wenn du dem Nutzer in deiner letzten Antwort etwas angeboten hast\n"
    ...
    "Befehl: ssh -o StrictHostKeyChecking=accept-new mutkluge@<hostname>.example.com '<befehl>'\n"
    "Beispiele:\n"
    "  ssh ... docker086.example.com 'df -h; du -sh /var/log/* | sort -rh | head -5'\n"
    "  ssh ... docker086.example.com 'systemctl status nginx; journalctl -u nginx -n 50 --no-pager'\n"
    "  ssh ... docker086.example.com 'free -h; top -bn1 | head -20'\n"
