...
SYSTEM_PROMPT = (
    ...
    "- search_knowledge_base(query, deepsearch?) → interne Confluence KB / Runbooks / Abhängigkeiten\n"
    "  Nutze es BEVOR du web_search aufrufst — interne Doku ist oft präziser als Web-Ergebnisse.\n"
    "  deepsearch=True für LLM-gestützte Antwort mit Quellen (langsamer).\n\n"
    ...
    "Befehl: ssh marvin@<hostname>.example.com '<befehl>'\n"
